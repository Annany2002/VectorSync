...
// Common represents fields that are common to multiple entities
type Common struct {
...
func (x *Common) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Common) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
const file_api_proto_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x19api/proto/v1/common.proto\x12\x06common\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8e\x01\n" +
	"\x06Common\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x129\n" +
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtB0Z.github.com/Annany2002/vector-sync/api/proto/v1b\x06proto3"
...
var file_api_proto_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_api_proto_v1_common_proto_depIdxs = []int32{
	1, // 0: common.Common.created_at:type_name -> google.protobuf.Timestamp
	1, // 1: common.Common.updated_at:type_name -> google.protobuf.Timestamp
