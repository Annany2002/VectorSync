...
func (x *FullTextSearchRequest) GetIncludeVector() bool {
	if x != nil {
		return x.IncludeVector
	}
	return false
...
func (x *BatchDeleteDocumentRequest) GetDocumentIds() []string {
	if x != nil {
		return x.DocumentIds
	}
	return nil
...
const file_document_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\xaa\x01\n" +
	"\x15FullTextSearchRequest\x12#\n" +
	"\rcollection_id\x18\x01 \x01(\tR\fcollectionId\x12\x14\n" +
	"\x05query\x18\x02 \x01(\tR\x05query\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit\x12\x19\n" +
	"\bmin_rank\x18\x04 \x01(\x02R\aminRank\x12%\n" +
	"\x0einclude_vector\x18\x05 \x01(\bR\rincludeVector\"H\n" +
